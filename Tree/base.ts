/**
 * Название: Binary Search Tree Implementation
 * Условие: Реализовать бинарное дерево поиска с поддержкой операций добавления узла (add),
 *         поиска узла (find) и вывода структуры дерева.
 * Пример:
 *   Добавлены узлы: 5, 3, 7, 1, 2, 4, 9, 11, 8
 *   Вывод структуры дерева должен отображать корректную иерархию
 */
