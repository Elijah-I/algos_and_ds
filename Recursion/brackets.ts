/**
 * Название: Validate Bracket Matching
 * Условие: Дано строка, содержащая только символы '(', ')', '{', '}', '[' и ']'.
 *         Нужно проверить, является ли строка валидной: каждая открывающая скобка должна иметь
