/**
 * Название: Max Heap Implementation
 * Условие: Реализовать структуру данных "макс-куча" (Max Heap) с поддержкой вставки элементов, удаления корня,
 *         а также восстановлением свойств кучи после изменений.
 * Пример:
 *   Ввод: insert(10), insert(5), insert(17), insert(4), insert(22)
 *   Вывод после print(): [22, 17, 10, 4, 5]
 *   После remove(): [17, 5, 10, 4]
 */
