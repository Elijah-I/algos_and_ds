/**
 * Название: Search a 2D Matrix
 * Условие: Дан двумерный массив, в котором каждая строка отсортирована по возрастанию,
 *         а первое число следующей строки больше последнего числа предыдущей.
 *         Нужно определить, содержится ли целевое значение в матрице.
 * Пример:
 *   Ввод: matrix = [[1], [3], [5]], target = 5
 *   Вывод: true
 */
